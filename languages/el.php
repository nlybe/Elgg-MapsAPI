...
$language = array(
    ...
    'amap_maps_api:menu' => 'Χάρτης',
    'amap_maps_api:location' => 'Τοποθεσία: %s', 
    'amap_maps_api:search:radius:meters' => 'ακτίνα (μέτρα)',	
    'amap_maps_api:search:radius:km' => 'ακτίνα (χμ)',
    'amap_maps_api:search:radius:miles' => 'ακτίνα (μίλια)',
    'amap_maps_api:search:meters' => 'μέτρα',
    'amap_maps_api:search:km' => 'χμ',
    'amap_maps_api:search:miles' => 'μίλια', 
    'amap_maps_api:all' => 'Global Map',
    'amap_maps_api:members' => 'Χρήστες',
    'amap_maps_api:groups' => 'Ομάδες',
    'amap_maps_api:agora' => 'Αγγελίες',
    'amap_maps_api:pages' => 'Σελίδες',
    'amap_maps_api:disabled' => 'To plugin Agoramap Maps Api δεν είναι ενεργοποιημένο',
    'amap_maps_api:user:logged_out' => 'Πρέπει να συνδεθείτε για να δείτε αυτή τη σελίδα',
    'amap_maps_api:user:coords_not_set' => 'Δεν έχετε εισάγει την τοποθεσία σας στο προφίλ σας.',
    'amap_maps_api:search:error:location_empty' => 'Δεν προσδιορίσατε τοποθεσία αναζήτησης',
    'amap_maps_api:search:error:radius_invalid' => 'Η ακτίνα αναζήτησης πρέπει να είναι αριθμός',
    'amap_maps_api:search:error:action_undefined' => 'Seach action is undefined',
    'amap_maps_api:input:map:title' => 'Χάρτης με Τοποθεσίες',
    'amap_maps_api:input:autocomplete:title' => 'Autocomplete location',
    'amap_maps_api:form:location' => 'Τοποθεσία', 
    'amap_maps_api:form:setlocation' => 'Τοποθεσία', 
    'amap_maps_api:form:search' => 'Αναζήτηση', 
    'amap_maps_api:form:latlon' => 'Συντεταγμένες: ',     
    ...
    //search 
    'amap_maps_api:search' => 'Αναζήτηση ανά τοποθεσία',
    'amap_maps_api:search:keyword' => 'λέξη κλειδί',
    'amap_maps_api:search:location' => 'τοποθεσία',
    'amap_maps_api:search:location:select' => 'Επιλέχτε Τοποθεσία',
    'amap_maps_api:search:radius' => 'ακτίνα (μέτρα)',
    'amap_maps_api:search:radius:meters' => 'ακτίνα (μέτρα)',
    'amap_maps_api:search:radius:km' => 'ακτίνα (χμ)',
    'amap_maps_api:search:radius:miles' => 'Ακτίνα (μίλια)',
    'amap_maps_api:search:meters' => 'μέτρα',
    'amap_maps_api:search:km' => 'χμ',
    'amap_maps_api:search:miles' => 'μίλια',    
    'amap_maps_api:search:my_location' => 'Η τοποθεσία μου',
    'amap_maps_api:search:showradius' => 'Προβολή περιοχής αναζήτησης',
    'amap_maps_api:search:submit' => 'Αναζήτηση',
    'amap_maps_api:searchnearby' => 'Search nearby',
    'amap_maps_api:mylocationsis' => 'Η τοποθεσία μου: ',
    ...
    'amap_maps_api:search:personalized:empty' => '<h3>Δεν υπάρχουν αποτελέσματα στο χάρτη</h3>',
    'amap_maps_api:search:proximity' => '%2$s km',
    'amap_maps_api:search_types:proximity' => 'Τοποθεσία',    
